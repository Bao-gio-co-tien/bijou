import 'package:bijou/features/authentication/screens/signup/signup_phone.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Tên bạn là gì?', style: BijouTheme.heading,),
            ...
            ElevatedButton(
                onPressed: () => Get.to(() => const SignUpPhone()),
